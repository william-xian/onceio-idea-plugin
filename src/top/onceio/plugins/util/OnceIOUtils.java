...
/**
 * @author ProjectOnceIO Team
 * @author Plushnikov Michail
 */
public class OnceIOUtils {
  public static final String ONCEIO_INTERN_FIELD_MARKER = "$";
...
Various problems with spring have also been reported. See issue #287, issue #271, and issue #43. */
  ...
  public static String getGetterName(final @NotNull PsiField psiField) {
    ...
    return OnceIOUtils.toGetterName(accessorsInfo, psiFieldName, isBoolean);
  }
