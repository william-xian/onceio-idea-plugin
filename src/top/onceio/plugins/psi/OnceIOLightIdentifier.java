 ...
 */
public class OnceIOLightIdentifier extends LightIdentifier {
  private String myText;

  public OnceIOLightIdentifier(PsiManager manager, String text) {
    super(manager, text);
    myText = text;
  }
  ...
  public boolean equals(Object o) {
    ...
    OnceIOLightIdentifier that = (OnceIOLightIdentifier) o;
