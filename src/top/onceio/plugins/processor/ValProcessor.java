...
public class ValProcessor extends AbstractProcessor {
  ...
  private static final String ONCEIO_VAL_NANE = "val";
  private static final String ONCEIO_VAR_NAME = "var";
  private static final String ONCEIO_VAL_FQN = "lombok.val";
  private static final String ONCEIO_VAR_FQN = "lombok.var";
  private static final String ONCEIO_VAR_EXPERIMENTAL_FQN = "lombok.experimental.var";
  ...
  private static boolean isPossibleVal(@Nullable String shortName) {
    return ONCEIO_VAL_NANE.equals(shortName);
  }

  private static boolean isVal(@Nullable String fullQualifiedName) {
    return ONCEIO_VAL_FQN.equals(fullQualifiedName);
  }

  private boolean isPossibleVar(@Nullable String shortName) {
    return ONCEIO_VAR_NAME.equals(shortName);
  }

  private boolean isVar(@Nullable String fullQualifiedName) {
    return ONCEIO_VAR_FQN.equals(fullQualifiedName) || ONCEIO_VAR_EXPERIMENTAL_FQN.equals(fullQualifiedName);
  }
